...
var ItemCoverage_1 = require("../../entities/ItemCoverage");
var typeorm_1 = require("typeorm");
var ItemCoverageDAO = /** @class */ (function () {
    function ItemCoverageDAO() {
        this.dao = typeorm_1.getRepository(ItemCoverage_1.ItemCoverage);
    }
    ItemCoverageDAO.prototype.search = function (data) {
    ...
    ItemCoverageDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ItemCoverageDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ItemCoverageDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ItemCoverageDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ItemCoverageDAO.prototype.findAll = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.find(data)];
    ...
    return ItemCoverageDAO;
}());
exports.ItemCoverageDAO = ItemCoverageDAO;
