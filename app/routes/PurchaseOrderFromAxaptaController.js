...
var PurchaseOrderFromAxaptaService_1 = require("../services/PurchaseOrderFromAxaptaService");
var PurchaseOrderFromAxaptaController = /** @class */ (function () {
    function PurchaseOrderFromAxaptaController() {
        this.componentName = "SalesLine";
        this.router = express_1.Router();
        this.service = new PurchaseOrderFromAxaptaService_1.PurchaseOrderFromAxaptaService();
    }
    PurchaseOrderFromAxaptaController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    PurchaseOrderFromAxaptaController.prototype.getRouter = function () {
        var _this = this;
        this.router.get("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, reqId, result, params, id, error_1;
    ...
    return PurchaseOrderFromAxaptaController;
}());
exports.PurchaseOrderFromAxaptaController = PurchaseOrderFromAxaptaController;
