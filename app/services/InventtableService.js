...
var InventtableService = /** @class */ (function () {
    function InventtableService() {
        this.inventtableDAO = new InventtableDAO_1.InventtableDAO();
        this.rawQuery = new RawQuery_1.RawQuery();
    }
    InventtableService.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.inventtableDAO.entity(id)];
                    case 1:
                        data = _a.sent();
    ...
    InventtableService.prototype.search = function (reqData) {
        return __awaiter(this, void 0, void 0, function () {
            var items, data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        return [4 /*yield*/, this.rawQuery.getIitemIds()];
                    case 1:
                        items = _a.sent();
                        data = void 0;
                        if (!(items.length > 0)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.inventtableDAO.search(reqData, items)];
                    case 2:
                        data = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
...
exports.InventtableService = InventtableService;
